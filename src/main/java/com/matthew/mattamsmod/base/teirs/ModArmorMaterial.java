...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    BRASS("brass", 10, new int []{2, 5, 6, 2}, 25,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 1.0F, 1.0F,
            () -> {return Ingredient.fromItems(BrassItems.BRASS_INGOT.get());}
    ),
    TITANIUM("titanium", 40, new int []{4, 6, 10, 5}, 25,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, 2.0F,
            () -> {return Ingredient.fromItems(TitaniumItems.TITANIUM_INGOT.get());}
    );
